...
class WorldMapSystem {
    ...
    async getMapFiles() {
        ...
        const knownMaps = [
            ...
            'maison', 'mapdonjonslime', 'mapdonjonslime2', 'mapdonjonslimeboss', 'mapzonealuineeks1', 'mazonehaut1aluineeks1', 'villagesortisud', 'villagesbasgauche', 'villagecentre', 'villagebasdroite', 'villagecentredroite', 'villagecentregauche', 'villagehautgauche', 'villagesortinord', 'villagehautdroite', 'banque'
        ];
    ...
    calculateMapPosition(mapName) {
        ...
        const mapPositions = {
            ...
            'map6': { x: 2310, y: 0 },                // map6 à droite de map5 (Y = 0)
            'map7': { x: 3080, y: 0 },                // map7 à droite de map6 (Y = 0)
            ...
            'villagesortisud': { x: 3080, y: -400 },         // villagesortisud à droite de map7
            'villagesbasgauche': { x: 2310, y: -400 },          // villagesbasgauche en bas à gauche
            'villagecentre': { x: 3080, y: -800 },             // villagecentre au centre, entre les villages
            'villagebasdroite': { x: 3850, y: -400 },           // villagebasdroite en bas à droite
            'villagecentredroite': { x: 3850, y: -800 },          // villagecentredroite au centre à droite
            'villagecentregauche': { x: 2310, y: -800 },             // villagecentregauche au centre à gauche
            'villagehautgauche': { x: 2310, y: -1200 },                  // villagehautgauche en haut à gauche
            'villagesortinord': { x: 3080, y: -1200 },                 // villagesortinord en haut au nord
            'villagehautdroite': { x: 3850, y: -1200 },                 // villagehautdroite en haut à droite
            'banque': { x: -9999, y: -9999 },                            // banque cachée de la minimap
